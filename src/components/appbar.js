class AppBar extends HTMLElement {
	...
	render() {
		this.innerHTML = `<nav class="flex justify-between items-center px-10 md:px-[68px] h-24 relative">
      <a href="" class="brand text-2xl font-bold">TopNews</a>
      <ul
        class="mt-2 text-base font-medium w-[420px] overflow-x-auto whitespace-nowrap absolute top-24 h-9 md:w-auto md:overflow-visible md:whitespace-normal md:static md:top-0 md:h-auto">
