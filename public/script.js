	...
	var n = {
			16: (n, e, t) => {
				...
				var r = t(81),
					...
					i = t(645),
					a = t.n(i)()(o());
				a.push([n.id, '@import url(https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap);']), a.push([n.id, '\r\n', '']);
				const s = a;
			},
			668: (n, e, t) => {
				t.d(e, { Z: () => s });
			...
			379: (n) => {
				...
				function r(n, r) {
					for (var i = {}, a = [], s = 0; s < n.length; s++) {
						...
						i[l] = c + 1;
						var p = t(u),
							h = { css: d[1], media: d[2], sourceMap: d[3], supports: d[4], layer: d[5] };
	...
	(t.n = (n) => {
		...
		(() => {
			var n = t(379),
				...
				h = t(16),
				f = {};
			(f.styleTagTransform = p()), (f.setAttributes = d()), (f.insert = a().bind(null, 'head')), (f.domAPI = o()), (f.insertStyleElement = c()), e()(h.Z, f), h.Z && h.Z.locals && h.Z.locals;
			var b = t(668),
				m = {};
			(m.styleTagTransform = p()), (m.setAttributes = d()), (m.insert = a().bind(null, 'head')), (m.domAPI = o()), (m.insertStyleElement = c()), e()(b.Z, m), b.Z && b.Z.locals && b.Z.locals;
		})();
})();
